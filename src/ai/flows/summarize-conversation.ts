...
/**
 * @fileOverview Summarizes a conversation using GenAI.
 *
...
const SummarizeConversationInputSchema = z.object({
  conversation: z.string().describe('The complete conversation history to summarize.'),
});
...
const summarizeConversationPrompt = ai.definePrompt({
  ...
  prompt: `Summarize the following conversation. Be concise and focus on the main points discussed:\n\n{{{conversation}}}`,}
);
